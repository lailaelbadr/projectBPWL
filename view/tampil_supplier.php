				...
				<div class="container">
					...
					<div class="col-md-3">
						<button type="button" class="btn mb-2 mb-md-0 btn-outline-secondary btn-block">
							<a href="../view/input/input_supplier.php">Input Data</a>
						</button>
					</div>
						...
						<table class="table custom-table text-center">
							...
							?>
								<tr>
									...
									<td>
										<a href="../view/edit/edit_supplier.php?id=<?php echo $x['kode_supplier']; ?>&aksi=edit">Edit</a>
										<a href="../controller/proses_supplier.php?id=<?php echo $x['kode_supplier']; ?>&aksi=hapus">Hapus</a>
									</td>
								</tr>
							<?php
							}
