						...
						<table class="table custom-table text-center">
							...
							?>
								<tr>
									...
									<td>
										<a href="../view/edit/edit_transaksi.php?id=<?php echo $x['kode_transaksi']; ?>&aksi=edit">Edit</a>
										<a href="../controller/proses_transaksi.php?id=<?php echo $x['kode_transaksi']; ?>&aksi=hapus">Hapus</a>
									</td>
								</tr>
							<?php
							}
